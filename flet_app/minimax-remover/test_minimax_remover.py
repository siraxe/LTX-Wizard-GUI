...
vae = AutoencoderKLWan.from_pretrained("./flet_app/minimax-remover/vae", torch_dtype=torch.float16)
transformer = Transformer3DModel.from_pretrained("./flet_app/minimax-remover/transformer", torch_dtype=torch.float16)
scheduler = UniPCMultistepScheduler.from_pretrained("./flet_app/minimax-remover/scheduler")
...
video_path = "./flet_app/minimax-remover/video.mp4"
mask_path = "./flet_app/minimax-remover/mask.mp4"
